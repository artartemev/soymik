    ...
    <div>
        <div className='info'>
            <div className='info__contacts'>
                ...
                <p>Контакты: ‎‎‎‎‎8 952 388 5999 / zakazveganov@yandex.ru</p>
                <p>Бухгалтерия: ‎‎‎‎8 900 649 5108 / veganovbuh@yandex.ru</p>
            </div>
            <div className='info__content'>
                ...
                <p>Срок годности колбас 45 суток, копчушки, сосисок и тофу 30 суток, подробности <a href="http://veganov.com/assortiment"> на сайте.</a> </p>
            </div>
        </div>
        <OrderForm />
